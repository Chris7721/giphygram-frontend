<template>
  <form @submit.prevent="login" autocomplete="off">
    <div v-if="hasError" class="hasError mb-10">
      <p>
    ...
    <div class="cont_detail form-group">
      ...
      <social-button :disabled="validation.password != 'valid-input' || validation.email != 'valid-input'" :loadig="logging_in">Log in &#x1F9D0;</social-button>
